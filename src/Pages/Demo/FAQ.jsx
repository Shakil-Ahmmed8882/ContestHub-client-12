const faqData = [
  {
    ...
    answer:
      "To enter a contest, you need to review the task submission instructions and submit your entry before the deadline. Most contests require you to upload files like documents, images, audio, video, etc.",
  },
  {
    question: "What are the different contest types on the platform?",
    answer:
      "The platform has contests across various categories like business, tech, gaming, design, data science, writing, photography, music etc.",
  },
  {
    question: "How much does it cost to participate in contests?",
    answer:
      "Participation in the contests is free. You just need to submit your entries before the deadline to get a chance to win prizes.",
  },
  {
    question: "What are the judging criteria for entries?",
    answer:
      "Entries are judged based on relevance to the contest topic, creativity, innovation, impact, functionality etc. Specific judging metrics are defined for each contest.",
  },
  {
    question: "When are contest winners announced?",
    answer:
      "Winners are announced after the contest deadline once judging is completed. Each contest page shows the announcement date for results.",
  },
  {
    question: "How are prizes given to contest winners?",
    answer:
      "Prize money is directly transferred to the winner's bank account or digital wallet. Certificates and trophies may also be awarded.",
  },
  {
    question: "Can I suggest a contest topic to be hosted?",
    answer:
      "Yes, you can suggest contest ideas by contacting the admin team or the contest creators. Your suggestions will be reviewed for feasibility.",
  },
  {
    question:
      "Is there a limit on the number of contests I can participate in?",
    answer:
      "No, you can participate in as many contests as you wish to maximize your chances of winning.",
  },
];

const FAQ = () => {
  return (
    <div className="py-4 bg-[#F4F4F6]">
      <div className=" max-w-5xl mx-auto bg-white rounded-lg px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
        ...
        <div className="mt-20">
          <ul className="">
            {faqData?.map((faq) => (
              <li key={faq} className="text-left bg-white mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className=" p-5 px-10 w-full flex items-center">
                    <h4 className="text-md text-[20px] leading-6 font-medium text-gray-900">
                      {faq.question}
                    </h4>
                  </div>
                </div>
