          ...
          <div className="p-6 rounded-lg bg-white text-black ">
            ...
            <p className="text-[16px] text-gray-500 mt-2">
              {description.length > 50
                ...
                : description + "we are happy to see you in contestHub"}
            </p>
            {/* ... */}
            <div className=" mt-2 flex rounded-lg  items-center gap-1">
              <BsFillPeopleFill className="text-[24px] text-gray-400"></BsFillPeopleFill>
              Participants
            ...
            <Link
              className="flex text-indigo-500 gap-2 relative  justify-end cursor-pointer  items-center text-[17px]"
              to={`/contest/${_id}`}>
              Details
