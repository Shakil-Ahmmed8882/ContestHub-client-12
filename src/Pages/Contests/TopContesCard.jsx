      ...
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <div className="rounded overflow-hidden flex flex-col max-w-2xl mx-auto border">
          <div className="sm:flex justify-between items-center pt-4 px-5">
            <a
              href="#"
              className="sm:w-8/12 font-medium text-md inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2 flex-1">
              The Best Activewear 
            </a>
            <div className="sm:w-4/12 flex-1 flex items-center sm:px-6 pb-4">
              <a href="#">
                <img
